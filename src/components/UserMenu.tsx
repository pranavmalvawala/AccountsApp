...
import { Col, Container, Tooltip } from "react-bootstrap";
import { Avatar, Divider, IconButton, ListSubheader, Menu, MenuItem, Typography } from "@mui/material";
import { Person as PersonIcon, Church as ChurchIcon } from "@mui/icons-material";
  ...
  return (
    <>
      <IconButton onClick={handleClick} color="inherit" aria-controls={open ? 'account-menu' : undefined} aria-haspopup="true" aria-expanded={open ? 'true' : undefined} style={{ outline: "0px !important" }} >
        <Avatar sx={{ width: 32, height: 32, marginRight: 1 }}><PersonIcon /></Avatar>
